...
public class BookApiImpl implements BookApi {
    ...
    public String searchBook(String title, String page) {
        return HttpUtil.httpGet(Constant.PATH_OPEN_LIB + "?token=" + Constant.token + "&libcode=" + Constant.LIB_CODE + "&queryparam=title&queryvalue=" + title + "&page=" + page);
    }

    @Override
    public String getBookDetails(String recNo) {
        return HttpUtil.httpGet(Constant.PATH_OPEN_LIB + "?token=" + Constant.token + "&bookrecno=" + recNo);
    }
